...
{
    public class SV_SpatialMappingManager : UnityEngine.Networking.NetworkBehaviour
    {
        ...
        [UnityEngine.Networking.SyncVar(hook="OnSpatialMappingSerialized")]
        ...
        public class SyncListSpatialMappingChunk : UnityEngine.Networking.SyncListStruct<SpatialMappingChunk> { }
